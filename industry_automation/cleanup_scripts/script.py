...
def get_etree_content(file_path):
    try:
        ...
        print(f"Error while getting etree content of file ({file_path}): {e}")
        raise
...
def write_etree_content(file_path, etree_content):
    try:
        ...
        print(f"Error while write etree content to file ({file_path}): {e}")
        raise
...
def arrange_demo_files(ind_name, manifest_demo_file_list):
    try:
        ...
        print(f"Error while renamming file: {e}")
        raise
    ...
    try:
        ...
        print(f"Unable to read manifest file: {e}")
        raise
    ...
    try:
        ...
        print(f"Unable to write manifest file: {e}")
        raise
    return
...
"""
        ...
        try:
            ...
            print(f"Unable to write website_theme_apply.xml file: {e}")
            raise
    return
