...
from ..cleanup_scripts import script
...
class ProjectTask(models.Model):
    ...
    def export_module_zip(self, attachment, module_name, version, category):
        try:
            ...
            res = self.env['ir.model.fields'].search_read()
            breakpoint()
            ...
            try:
                script.main(module_name, category, restore_db_name, studio_extract_path, port, base_temp_dir)
